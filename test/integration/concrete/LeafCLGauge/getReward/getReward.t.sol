...
contract GetRewardIntegrationConcreteTest is LeafCLGaugeTest {
    ...
    function test_GetRewardWithMultipleDepositors() public {
        ...
        assertEq(gauge.lastUpdateTime(aliceTokenId), block.timestamp);
        ...
        assertEq(gauge.lastUpdateTime(bobTokenId), block.timestamp);
    ...
    function test_GetRewardWithStaggeredDepositsAndWithdrawals() public {
        ...
        bobRewardBalance = leafXVelo.balanceOf(users.bob);
    ...
    function test_GetRewardAsVoterWithMultipleDeposits() public {
        ...
        assertEq(gauge.lastUpdateTime(tokenId2), block.timestamp);
    }
}
